...
//    const std::string& rapidsDatasetRootDir = "/home/waf13/cugraph/datasets";
//    if ((a != "") && (a[0] != '/')) {
...
//
//// Read
//ASSERT_EQ((cugraph::test::mm_to_coo<int, double>(
...
//};
//
//TEST_P(Tests_Mst, CheckFP32_T) { run_current_test<double>(GetParam()); }
//
//INSTANTIATE_TEST_SUITE_P(simple_test,
//    Tests_Mst,
//    ::testing::Values(Mst_Usecase("test/datasets/USA-road-d.NY.mtx")));
//

...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "a11519016ce791239dc019615f3cffac6560534b"
  WORKING_DIRECTORY "/home/alex/mst/cugraph/cpp/build/_deps/cuhornet-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "a11519016ce791239dc019615f3cffac6560534b")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("a11519016ce791239dc019615f3cffac6560534b" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/a11519016ce791239dc019615f3cffac6560534b")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/alex/mst/cugraph/cpp/build/_deps/cuhornet-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/alex/mst/cugraph/cpp/build/_deps/cuhornet-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
